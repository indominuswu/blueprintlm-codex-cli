...
async fn model_selects_expected_tools() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            "get_project_directory".to_string(),
            "get_project_context".to_string(),
            "list_directory".to_string(),
            "list_assets".to_string(),
            "open_asset_in_editor".to_string(),
            "get_blueprint_graph".to_string(),
            "compile_blueprint".to_string(),
            "query_log".to_string(),
            "execute_console_command".to_string(),
